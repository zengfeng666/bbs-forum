            ...
            <div class="card-wrapper">
                ...
                <div class="card fat">
                    <div class="card-body">
                        ...
                        <form action="${pageContext.request.contextPath}/user/login" method="post" class="my-login-validation" novalidate="">
                            ...
                            <div class="form-group">
                                <label for="password">Password
                                    <a href="${pageContext.request.contextPath}/pages/forget.jsp" class="float-right">
                                        Forgot Password?
                                    </a>
                                </label>
                            ...
                            <div class="mt-4 text-center">
                                Don't have an account? <a href="${pageContext.request.contextPath}/pages/register.jsp">Create One</a>
                            </div>
                        </form>
                    </div>
                </div>
